...
const AddPet = () => {
    const addPet = async (e) => {
        ...
        // send data to server
        try {
            const res = await fetch(`${process.env.NEXT_PUBLIC_LOCAL_URI}/dashboard/add-pet`, {
                method: 'POST',
                headers: {
            ...
            if (res.ok) {
                toast.success('Pet added to your listing', {
                    position: "top-center",
                    autoClose: 5000,
        ...
        <div className='flex flex-col flex-1'>
            {
                session?.user ? (
                    <div className="py-12 px-10 w-full mx-auto">
                        ...
                        <div className="p-6 sm:p-8 rounded-xl secondary-border bg-white text-black shadow-sm">
